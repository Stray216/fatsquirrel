...
public class GameImpl3 extends Game
{
	public GameImpl3(XY size, int wallCount, int plantCount, int beastCount, UI ui)
	{
	...
	public GameImpl3()
	{
		super(new State(new Board(new BoardConfig())), FxUI.createInstance(new BoardConfig().getSize()), 1);
	}
